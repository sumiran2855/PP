...
export function AboutSection() {
  ...
  return (
    <section id="about" className="scroll-mt-28 sm:scroll-mt-32 py-20 sm:py-32 relative overflow-hidden bg-gradient-to-b from-[#f1f5f9] via-[#f8fafc] to-[#eef2ff] dark:from-[#080b14] dark:via-[#0e1324] dark:to-[#090d1a] transition-colors duration-500">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <Scroll3DWrapper intensity={4} depth={20}>
          ...
          >
            {/* IDE Window Header */}
            <div>
              <div className="flex items-center justify-between pb-4 border-b border-slate-800 select-none gap-2">
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <span className="text-[11px] text-slate-400 ml-1 sm:ml-2 flex items-center gap-1.5 truncate">
                    ...
                    <span className="truncate">sumiran.config.ts</span>
                  </span>
                </div>

                <button
                  onClick={copyConfigCode}
                  className="shrink-0 p-1.5 rounded-lg border border-slate-800 bg-slate-900 hover:bg-slate-800 text-slate-400 hover:text-white transition-all cursor-pointer flex items-center gap-1 text-[11px]"
          ...
          {/* ======================================================== */}
          {/* BENTO GRID ROW 3: Customers Finished, Projects Shipped & Metric Counters */}
          {/* ======================================================== */}
          <CounterStats />
        </Scroll3DWrapper>
