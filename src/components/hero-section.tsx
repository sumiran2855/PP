            ...
            >
              ...
              <div className="relative rounded-2xl border border-slate-200/90 dark:border-slate-800/90 bg-white/90 dark:bg-slate-950/90 backdrop-blur-2xl shadow-2xl shadow-indigo-500/10 dark:shadow-indigo-500/20 overflow-hidden transition-all duration-300">
                ...
                <div
                  ...
                  className="flex items-center justify-between px-4 py-3 bg-slate-100/90 dark:bg-slate-900/90 border-b border-slate-200/80 dark:border-slate-800/80 backdrop-blur-md select-none"
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] sm:text-xs font-mono text-slate-500 dark:text-slate-400 ml-2 flex items-center gap-1.5">
                  ...
                  <div className="flex items-center gap-1 bg-slate-200/60 dark:bg-slate-800/60 p-0.5 rounded-lg border border-slate-300/50 dark:border-slate-700/50">
                    <button
